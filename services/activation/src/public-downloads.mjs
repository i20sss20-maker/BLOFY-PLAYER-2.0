...
<header class="nav"><a class="brand" href="/"><img src="/blofy-logo.png" alt="">BLOFY PLAYER</a><nav class="nav-links" aria-label="روابط الموقع"><a href="/">الرئيسية</a><a href="/connect">ربط جهازك</a><a href="/privacy">الخصوصية</a><a href="/status">حالة الخدمات</a><a class="btn primary" href="https://updates.blofyplayer.com" rel="noopener">آخر إصدار</a></nav></header>
...
${primary && !unavailable ? `<a id="download-primary" class="btn primary download-main" href="/download/latest.apk"><span>تنزيل التطبيق الآن</span><span class="download-version" dir="ltr">${escapeHtml(primary.versionName)} · APK</span></a><p class="download-assurance">للتحديث: ثبّت فوق النسخة الحالية ولا تحذف التطبيق القديم.</p><p class="download-assurance">للـ Downloader استخدم الرابط السريع: <strong dir="ltr">blofyplayer.com/apk</strong></p>` : ''}
</section>
...
<footer class="foot"><a href="/">BLOFY PLAYER</a><a href="/downloads">التحميل</a><a href="/privacy">الخصوصية وحذف البيانات</a><a href="/connect">إدارة جهازك</a><a href="/status">حالة الخدمات</a><a href="https://updates.blofyplayer.com" rel="noopener">مركز الإصدارات</a></footer></div></body></html>`;
}
