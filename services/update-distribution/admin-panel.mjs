...
import { listApps, upsertApp, deleteApp, inspectRemoteApk, refreshManagedApps, getAppUpdateState, getDownloadStats, getAppHealthState, refreshAppHealth } from './app-library.mjs';
...
export async function renderAdmin(message = '') {
  ...
  const [apps, updateState, downloadStats, healthState] = await Promise.all([
    listApps(true),
    getAppUpdateState(),
    getDownloadStats(),
    getAppHealthState()
