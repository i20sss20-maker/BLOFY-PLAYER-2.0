...
const RC07552_RELEASE = {
  versionCode: 2000070,
  versionName: '2.0.0-rc07.55.2',
  downloadUrl: 'https://updates.blofyplayer.com/files/releases/BLOFY-PLAYER-2.0-rc07.55.2-PRODUCTION-SIGNED.apk',
  releaseNotes: 'BLOFY PLAYER 55.2 — إصلاح مشتركين BLOFY للقوائم القديمة عبر التحويل التلقائي من Proxy إلى Direct Xtream، دعم الانتقال بين blofyplayer.com و api.blofyplayer.com، منع HTTP 456 الناتج عن البروكسي القديم، وإصلاح تداخل صف البوسترات فوق عناوين المكتبة. محركات Media3 وFFmpeg وfallback الأساسية كما هي.',
  minSupportedVersionCode: 1,
  stage: 'public'
};
