...
function renderAppLibrary(apps) {
  ...
  return `<section class="apps-section">
    <div class="apps-intro">
      <div><span class="eyebrow">TV APPS · DIRECT APK</span><h2>تطبيقات مفيدة للشاشات والرسيفرات</h2><p>روابط تحميل مباشرة للـ APK بدون تحويلك إلى موقع التطبيق.</p></div>
      <span class="apps-count">${apps.length} تطبيق</span>
    </div>
